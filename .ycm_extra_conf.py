# Generated by YCM Generator at 2018-03-20 13:59:14.000003
...
flags = [
    ...
    '-Dcurlpp_EXPORTS',
    '-I' + os.getcwd() + '/3rdParty/curlpp/include',
    '-I' + os.getcwd() + '/3rdParty/gtest/googlemock',
    '-I' + os.getcwd() + '/3rdParty/gtest/googlemock/include',
    '-I' + os.getcwd() + '/3rdParty/gtest/googletest',
    '-I' + os.getcwd() + '/3rdParty/gtest/googletest/include',
